	  ...
	  <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/files/css/blue.css">
<style>
.col{
...
<div class="container">
            <div class="row">
   <div class="col-xs-12 col-sm-12 col-md-12 pull-left blgo-full-wrap no-pad" style='margin-top:30px;'>
<?php
	if(is_array($wishlist_history) && !empty($wishlist_history)){
		...
		{ 
			...
			<div class="blog-box wow fadeInLeft" data-wow-delay="0.5s" data-wow-offset="150">
		                        <a href="<?php echo Yii::app()->request->baseUrl; ?>/albums/details/<?php echo $history['song_url_title']; ?>/<?php echo $history['song_id']; ?>"><img alt="" src="<?php echo Yii::app()->params['song_url'].'songs_thumb/'.$history['song_img_url']; ?>" class="*img-responsive" height="250px !important" />
		                        <div class="blog-box-title"><?php echo $history['song_title']; ?></div></a>
		                        <p><?php echo substr($history['song_description'], 0, 75); ?></p>
